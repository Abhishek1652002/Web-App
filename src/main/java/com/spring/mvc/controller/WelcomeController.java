...
public class WelcomeController {
	...
	public String greeting() {
		...
		System.out.println("welcome.controller.greeting()");
		return "index";
	}
	...
	public String pathVarExample(@PathVariable(name="id") int id, Model model) {
		...
		model.addAttribute("firstCookie", "Sorry this:"+id+" User is not found in our DB" );
...
//	}
	...
	public String setCookieVal(HttpServletResponse response, Model model) {
		...
		Cookie cookie1=new Cookie("firstCookie","SensitiveInformation");
         cookie1.setMaxAge(10);//100 seconds
         response.addCookie(cookie1);
         
         System.out.println("setcookie val");
